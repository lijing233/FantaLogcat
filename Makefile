...
test: generate
	xcodebuild -project FantaLogcat.xcodeproj -scheme FantaLogcat -derivedDataPath $(DERIVED_DATA) -destination 'platform=macOS,arch=arm64' -only-testing:FantaLogcatTests test
